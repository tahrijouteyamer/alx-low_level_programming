...
/**
 * check_elf - a checker to see if the file is an ELF file
 ...
 * @e_ident: the pointer to an array containing the ELF magic numbers
 * Description: the magic numbers are seperated
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * main - displays the information in the ELF header at the start of an ELF file
 * @argc: the number of arguments supplied to the program
 * @argv: the array of pointers to the arguments
 * Return: on success 0
 * Description: if the file is not an ELF File or the function fails then exit code 98
 */
